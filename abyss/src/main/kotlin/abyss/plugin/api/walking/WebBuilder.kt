...
class WebBuilder {
    ...
    fun addMenu(tile: WorldTile, action: abyss.plugin.api.actions.MenuAction, vararg args: Int) {
        val v = WebVertex(web.nextId(), tile)
        web.addVertex(v)
        val last = lastVertex
        if(last != null) {
    ...
    fun addMenuTo(tile: WorldTile, action: abyss.plugin.api.actions.MenuAction, vararg args: Int) {
        val v = WebVertex(web.nextId(), tile)
        web.addVertex(v)
        val last = lastVertex
        if(last != null) {
    ...
    fun addObject(tile: WorldTile, action: abyss.plugin.api.actions.ObjectAction, objectId: Int, objectTile: WorldTile) {
        val v = WebVertex(web.nextId(), tile)
        web.addVertex(v)
        val last = lastVertex
        if(last != null) {
