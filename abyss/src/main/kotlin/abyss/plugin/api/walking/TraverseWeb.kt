...
class TraverseWeb {
    ...
    companion object {
        ...
        fun linkMenuEdge(v1: WebVertex, v2: WebVertex, action: abyss.plugin.api.actions.MenuAction, vararg args: Int) {
            if(args.size > 4)
        ...
        fun linkMenuEdgeTo(v1: WebVertex, v2: WebVertex, action: abyss.plugin.api.actions.MenuAction, vararg args: Int) {
            if(args.size > 4)
                error("Too many menu args")
            val e1 = WebEdge(v1, v2, MenuEdge(action, *args))
            v1.edges.add(e1)
        ...
        fun linkObjectEdgeTo(v1 : WebVertex, v2: WebVertex, action: abyss.plugin.api.actions.ObjectAction, objectId: Int, tile: WorldTile) {
