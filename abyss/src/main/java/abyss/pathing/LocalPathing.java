...
public class LocalPathing {
	...
	public static int getLocalStepsTo(Vector3i start, int srcSize, RouteStrategy strategy, boolean findAlternative) {
		List<Vector3i> steps = findLocalRoute(start, srcSize, strategy, findAlternative);
		return steps == null ? -1 : steps.size();
	}

	public static List<Vector3i> findLocalRoute(Vector3i start, int srcSize, RouteStrategy strategy, boolean findAlternative) {
		isAlternative = false;
		...
		List<Vector3i> stepList = new ArrayList<>();
