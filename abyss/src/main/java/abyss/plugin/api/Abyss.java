...
/**
 * Provides access to Abyss itself.
 */
public final class Abyss {
     ...
     *
     * @return The method to use for randomizing the world on login.
     */
     ...
     *
     * @param type The new method to use for randomizing the world on login.
     */
     ...
     *
     * @return The world to set when logging in.
     */
     ...
     *
     * @param world The new world to set when logging in.
     */
    ...
    /**
     * Retrieves the introspection configuration bitmask.
     *
