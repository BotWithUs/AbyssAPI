...
public final class GroundItems {
     ...
     */
    public static GroundItem[] all(Predicate<GroundItem> filter) {
     ...
     */
    public static void forEach(Consumer<GroundItem> cb) {
        for (GroundItem i : all()) {
            cb.accept(i);
        }
    }
     ...
     */
    public static int count(Predicate<GroundItem> filter) {
